...
Shader "VacuumShaders/Curved World/One Directional Light/Cutout/Reflective"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="AlphaTest" 
			   ...
			   "CurvedWorldTag"="One Directional Light/Cutout/Reflective" 
	...
	SubShader 
	{
		Tags { "Queue"="AlphaTest" 
		       "IgnoreProjector"="True" 
			   "RenderType"="TransparentCutout" 
			   "CurvedWorldTag"="Unlit/Cutout/Reflective" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150
