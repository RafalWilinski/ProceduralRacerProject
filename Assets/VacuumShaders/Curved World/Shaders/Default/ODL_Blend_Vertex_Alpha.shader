...
Shader "VacuumShaders/Curved World/One Directional Light/Blend/Vertex Alpha"
{
	Properties    
	{          
		//Tag              
	...
	SubShader 
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="One Directional Light/Blend/Vertex Alpha" 
	...
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Unlit/Blend/Vertex Alpha" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100
