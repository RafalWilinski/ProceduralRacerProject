...
Shader "VacuumShaders/Curved World/One Directional Light/Blend/Detail"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="One Directional Light/Blend/Detail" 
	...
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Unlit/Blend/Detail" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150
