...
Shader "VacuumShaders/Curved World/One Directional Light/Reflective/Specular"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="One Directional Light/Reflective/Specular" 
	...
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Unlit/Reflective" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150
