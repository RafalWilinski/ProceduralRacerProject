...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent/Reflective"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
			   ...
			   "CurvedWorldTag"="Global/One Directional Light/Transparent/Reflective" 
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       "IgnoreProjector"="True" 
			   "RenderType"="Transparent" 
			   "CurvedWorldTag"="Global/Unlit/Transparent/Reflective" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150
