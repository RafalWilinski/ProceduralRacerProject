...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Blend/Vertex Alpha"
{
	Properties    
	{          
		//Tag              
	...
	SubShader 
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/Blend/Vertex Alpha" 
	...
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Global/Unlit/Blend/Vertex Alpha" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100
