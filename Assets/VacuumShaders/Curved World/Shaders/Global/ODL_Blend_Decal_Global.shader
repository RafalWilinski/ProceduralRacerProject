...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Blend/Decal"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Global/One Directional Light/Blend/Decal" 
	...
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Global/Unlit/Blend/Decal" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 150
