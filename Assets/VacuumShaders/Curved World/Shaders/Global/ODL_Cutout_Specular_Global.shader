...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Cutout/Specular"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="AlphaTest" 
			   ...
			   "CurvedWorldTag"="Global/One Directional Light/Cutout/Specular" 
	...
	SubShader 
	{
		Tags { "Queue"="AlphaTest" 
		       "IgnoreProjector"="True" 
			   "RenderType"="TransparentCutout" 
			   "CurvedWorldTag"="Global/Unlit/Cutout/Texture" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100
