...
Shader "Hidden/VacuumShaders/Curved World/Particles/~Additive-Multiply"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent" 
			   ...
			   "CurvedWorldTag"="Global/Particles/~Additive-Multiply" 
		...
		Pass
	    {
			...
			fixed4 frag_particle(vOutput i) : SV_Target 
			{
				...
				fixed4 retColor;
				retColor.rgb = tex.rgb * i.color.rgb * 2.0f * _Color.rgb;
				retColor.a = (1 - tex.a) * (i.color.a * 2.0f) * _Color.a;
