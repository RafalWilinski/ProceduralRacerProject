...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Transparent/Specular"
{
	Properties 
	{
		//Tag
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
			   ...
			   "CurvedWorldTag"="Global/One Directional Light/Transparent/Specular" 
	...
	SubShader 
	{
		Tags { "Queue"="Transparent+1" 
		       "IgnoreProjector"="True" 
			   "RenderType"="Transparent" 
			   "CurvedWorldTag"="Global/Unlit/Transparent/Texture" 
			   "CurvedWorldBakedKeywords"="" 
			 }
		LOD 100
