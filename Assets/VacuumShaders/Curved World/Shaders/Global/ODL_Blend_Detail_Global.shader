...
Shader "Hidden/VacuumShaders/Curved World/One Directional Light/Blend/Detail"
{
	Properties 
	{ 
		//Tag
	...
	SubShader 
	{
		Tags { "RenderType"="Opaque" 
			   "CurvedWorldTag"="Global/One Directional Light/Blend/Detail" 
	...
	{
		Tags { "RenderType"="Opaque" 
		       "CurvedWorldTag"="Global/Unlit/Blend/Detail" 
			   "CurvedWorldBakedKeywords"="" 
			  }
		LOD 150
