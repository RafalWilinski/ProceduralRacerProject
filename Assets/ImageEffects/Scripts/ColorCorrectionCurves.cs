...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ColorGradingCurves : PostEffectsBase
	{
        ...
        public ColorGradingMode mode;

        public bool  updateTextures = true;

        public Shader colorCorrectionCurvesShader = null;
        public Shader simpleColorGradingCurvesShader = null;
		...
		{
            CheckSupport (mode == ColorGradingMode.Advanced);

            ccMaterial = CheckShaderAndCreateMaterial (simpleColorGradingCurvesShader, ccMaterial);
