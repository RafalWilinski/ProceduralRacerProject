...
SubShader {
	Pass {
		...
		half4 frag (v2f i) : COLOR
		{
			...
			if(i.uv.y < flip_up)
				i.uv.y = (i.uv.y + flip_up);
			
			if(i.uv.y > flip_down)
				i.uv.y = (i.uv.y - flip_down);
			...
			// if(filterRadius > 0){
			//	color.r = redcolor.r * 1.02;
			//	color.b = greencolor.b * 1.02;
			//	color.g = greencolor.g * 1.02;
			// }else{
			//	color.g = redcolor.b * 1.02;
			//	color.b = greencolor.b * 1.02;
			//	color.r = greencolor.g * 1.02;
			// }
